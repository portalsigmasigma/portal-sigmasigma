      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="mb-6 space-y-2">
          ...
          <p className="text-xs sm:text-sm text-texto-secundario">
            Lista de matérias cadastradas no banco de dados.
          </p>
        </div>
        ...
        {carregando ? (
              ...
              >
                ...
                <div className="flex items-center gap-2 self-start sm:self-center">
                  ...
                  <button
                    ...
                    className="p-1.5 hover:bg-red-500/20 text-texto-secundario hover:text-red-400 rounded-lg transition-all text-xs cursor-pointer"
          ...
          <div className="bg-card border border-borda rounded-xl p-8 text-center text-xs text-texto-secundario">
            Nenhuma disciplina cadastrada no banco. Clique em "+ Nova Disciplina" para adicionar.
          </div>
        )}
      </div>
