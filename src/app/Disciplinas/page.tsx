...
export default function PaginaDisciplinas() {
  return (
    <div className="min-h-screen bg-fundo text-texto-principal p-4 sm:p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8 space-y-2">
        ...
        <p className="text-sm text-texto-secundario max-w-2xl">
          Selecione uma matéria para ver o acervo de materiais e provas associados a ela.
        </p>
      </div>

      {/* Grade de Cards (1 coluna no celular, 2 em tablet, 3 em PC) */}
        ...
        {listaDisciplinas.map((item) => (
          ...
          >
            <div>
              ...
              <h2 className="text-lg font-bold text-texto-principal group-hover:text-azul-texto transition-colors mb-1">
                {item.nome}
              </h2>
